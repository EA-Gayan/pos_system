      ...
      <div className="flex items-center justify-between px-10 py-6 bg-[#1a1a1a] shadow-lg">
        ...
        <div className="flex items-center justify-around gap-3">
          <button
            ...
            className={`text-sm font-semibold px-6 py-2.5 rounded-lg cursor-pointer transition-all duration-200 ${status === "all" ? "bg-gradient-to-r from-[#f6b100] to-[#e5a400] text-[#1a1a1a] shadow-lg scale-105" : "bg-[#2a2a2a] text-[#f5f5f5] hover:bg-[#333]"
              }`}
          >
            All
          </button>
          <button
            ...
            className={`text-sm font-semibold px-6 py-2.5 rounded-lg cursor-pointer transition-all duration-200 ${status === "booked" ? "bg-gradient-to-r from-[#f6b100] to-[#e5a400] text-[#1a1a1a] shadow-lg scale-105" : "bg-[#2a2a2a] text-[#f5f5f5] hover:bg-[#333]"
              }`}
          >
            Booked
          </button>
          <button
            ...
            className={`text-sm font-semibold px-6 py-2.5 rounded-lg cursor-pointer transition-all duration-200 ${status === "available" ? "bg-gradient-to-r from-[#f6b100] to-[#e5a400] text-[#1a1a1a] shadow-lg scale-105" : "bg-[#2a2a2a] text-[#f5f5f5] hover:bg-[#333]"
              }`}
          >
            Available
          </button>
